...
<div class="slider-wrapper theme-default">
	<div id="slider" class="nivoSlider">
		...
		<img src="deprixa_components/images/slider/a.jpg" data-thumb="deprixa_components/images/demo/news/1.jpg" alt="" title="#caption1" />
	</div>
...
<main class="slide">
					...
					<div class="col-sm-6">
						<div class="pod">
							<div class="media-body">
								...
								<h3>BAGAIMANA CARA KERJA-NYA</h3>
	...
	<section class="mpd-couriers">
		<header>
			<h2>BANDINGKAN KUALITAS JASA KAMI</h2>
		</header>
		<ul class="col-sm-12">
