...
<div class="container">
    ...
    <tbody>
				<article class="col-sm-8 col-md-9">	
					...
					<h5><strong>Perbarui Pengiriman</strong></h5>
					
					<ul class="list-unstyled product-list">
						<li class="row strong">
							<div class="col-md-4 col-sm-5"># Tracking</div>
							<div class="col-md-2 col-sm-5">Cetak Invoice</div>
							<div class="col-md-2 col-sm-2">STATUS</div>
							<div class="col-md-2 col-sm-3">berat</div>
							<div class="col-md-2 col-sm-3">Total Pengirimant</div>
						</li>
						<li class="row">
					...
					<div class="row user-data">
						<div class="col-md-4">
							...
							<ul>
								<li><strong>Nama:</strong> <?php echo $ship_name; ?></li>
								<li><strong>Phone:</strong> <?php echo $phone; ?></li>
								<li><strong>Alamat:</strong> <?php echo $s_add; ?></li>
						...
						<div class="col-md-3">
							...
							<ul>
								<li><strong>Nama:</strong> <?php echo $rev_name; ?></li>
								<li><strong>Phone:</strong> <?php echo $r_phone; ?></li>
								<li><strong>Alamat:</strong> <?php echo $r_add; ?></li>
						...
						<div class="col-md-5">
							...
							<ul>
								...
								<li><strong>Tujuan:</strong> <?php echo $pick_time; ?></li>
								<li><strong>Mode Pembayaran:</strong> <?php echo $book_mode; ?></li>
								<li><strong>Declared Value:</strong>&nbsp;$&nbsp;<?php echo $declarate; ?></li>
								<li><strong>Mode Pengiriman:</strong> <?php echo $mode; ?></li>								
								<li><strong>Tanggal/waktu dikirim:</strong> <?php echo $pick_date; ?></li>
								<li><strong>JADWAL DI TERIMA:</strong> <?php echo $schedule; ?></li>
								<li><strong>Deskripsi:</strong> <?php echo $comments; ?></li>
							</ul>
						</div>
					</div>
					...
					<div class="one_full">
									<div class="table-style">										
												...
												<h5><strong>Riwayat Pengiriman</strong></h5> 							
					...
					<h4 class="classic-title"><strong>PERBARUI STATUS</strong></h4>
					...
					<form action="process.php?action=update-status" method="post" name="frmShipment" id="frmShipment">
						<div class="row">
							...
							<!-- Origin Office -->
								<div class="col-md-3 form-groupform-group">
									<label for="zipcode" class="control-label">PROVINSI BARU:</label>
									<select name="status" class="form-control" >
										<option value="Finished">Diselesaikan</option>
										<option value="In-Transit">dalam Transit</option>
										<option value="On-Hold">Masih tertahan</option>
										<option value="Landed">Sudah Mendarat/Tiba</option>
										<option value="Delayed">Tertunda</option>
									</select>
								</div>	
							<!-- Comments -->
							<div class="col-md-3 form-groupform-group">
								<label for="message" class="control-label">Komentar:</label>
						...
						<div class="col-md-3 form-group">
							<p><font color="#FF6100"><strong>Perbarui Jika Diperlukan</strong></font></p>
							<br><br>
