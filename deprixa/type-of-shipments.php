							...
							<div class="row">
								...
								<div class="modal fade" id="nuevo" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
								  <div class="modal-dialog">
									<div class="modal-content">
									  <div class="modal-header">
										...
										<h4 class="modal-title" id="myModalLabel"><i class="fa fa-user-plus"></i> Tipe Produk Baru</h4>
									  </div>
								  ...
								  <div class="form-group" id="gapellido">
									<label for="type-of-packaging" class="col-sm-2 control-label">Tipe packaging </label>
									<div class="col-sm-10">
								  ...
								  <div class="form-group" id="gtelefono">
									<label for="dimensions" class="col-sm-2 control-label">Dimensi</label>
									<div class="col-sm-10">
