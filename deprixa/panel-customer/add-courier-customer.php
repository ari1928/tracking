				...
				<div class="row">
                    <div class="col-sm-12">
                        <div class="card-box table-responsive">
                            <h4 class="m-t-0 header-title"><b>Tambahkan Pelanggan Pengiriman</b></h4>
								...
								<table border="0" align="center" width="100%">
									...
									<form action="booking.php" method="post" id="nl-form" name="nl-form">
													...
													<div class="row">
													  ...
													  <label  class="control-label">ASAL<span class="required-field"><i class="fa fa-map-marker"></i></span></label>
													  ...
													  <div class="col-md-4 col-sm-4 col-xs-12 ">
													  <label  class="control-label">TUJUAN<span class="required-field"><i class="fa fa-map-marker"></i></span></label>
															<div class="input-group"> 
													  ...
													  <label  class="control-label">SERVICES<span class="required-field"><i class="fa fa-cog"></i></span></label>
														<div class="input-group">
																<select name="service" class="fa-glass booking_form_dropdown form-control" id="service" onclick="clear_service();">
																	<option value="" selected="selected">Tolong Pilih SERVICES</option>
																	...
																	<option value="" selected="selected">Tolong Pilih Tipe pengiriman</option>
													...
													?> 
														...
														<fieldset class="col-md-6">
															...
															<div class="form-group">
																<label  class="control-label">NAMA COSTUMER<span class="required-field">*</span></label>
															...
															<div class="row">
																...
																<div class="col-sm-4 form-group">
																	<label  class="control-label"><i class="fa fa-phone icon text-default-lter"></i>&nbsp;Alamat</label>
														...
														<fieldset class="col-md-6">
															...
															<div class="row" >
																<div class="col-sm-12 form-group">
																		<label  class="control-label"><i class="fa fa-user icon text-default-lter"></i>&nbsp;Nama Costumer<span class="required-field">*</span></label>
															...
															<div class="row" >
																<div class="col-sm-3 form-group">
																	<label  class="control-label">Jumlah Paket<span class="required-field">*</span></label>
																	<input name="Qnty" type="text" class="form-control"  placeholder="Quantity of Packages" required>
																</div>
																<div class="col-sm-2 form-group">
																	<label  class="control-label">berat<span class="required-field">*</span></label>
																	<input name="weight" type="text" class="form-control"  placeholder="  Kg" required>
																</div>
																
																<div class="col-sm-2 form-group">
																	<label  class="control-label">Panjangnya<span class="required-field">*</span></label>
																	 <input name="length" class="form-control" type="text" placeholder="  Length in cm">
																</div>
																
																<div class="col-sm-2 form-group">
																	<label  class="control-label">Lebar<span class="required-field">*</span></label>
																	<input name="width" class="form-control" type="text" placeholder="  Width in cm">
																</div>
																
																<div class="col-sm-2 form-group">
																	<label class="control-label">Tinggi<span class="required-field">*</span></label>
															...
															<div class="row" >
																<div class="col-sm-12 form-group">
																	<label class="control-label">Detail pengiriman</i></label>
