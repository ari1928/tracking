					...
					<div class="modal-dialog">
						<div class="modal-content">
							<div class="modal-header">
								...
								<br>
								<hr>
								<h5>BAYAR MELALUI BANK TRANSFER</h5></br>
								Nama Bank: <strong>BANK BCA</strong></br>
								Nama Akun: <strong>robi al akbar.</strong> </br>
								Nomor rekening: <strong>6542XXXXXXXX</strong></p>
								<hr>
							</div>
							<div class="modal-body">
								<h4 class="header-title m-t-0 m-b-20">Kirim Pembayaran</h4>
								<br>								
										...
										<div class="form-group clearfix">
											...
											<fieldset class="form-group">
											    ...
											    <div class="form-group">
													<label for="address" class="col-sm-2 control-label"># Pengiriman</label>
													<div class="col-sm-5">
