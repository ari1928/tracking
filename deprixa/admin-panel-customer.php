...
<div class="row">
                <div class="col-md-12">
                    <ul class="breadcrumbs-alt">
                        <li>
                            <a class="active-trail active" href="admin.php">Daftar Paket yang Dibayar</a>
                        </li>
                        <li>
                            <a  href="admin-credit.php">Daftar Paket yang akan dibayar</a>
                        </li>
                        <li>
                            <a   href="admin-on-delivery.php">daftar paket yang COD/Cash On Delivery</a>
                        </li>
						<li>
                            <a  class="current" href="admin-panel-customer.php">Admin Panel Pelanggan</a>
                        </li>
						<li>
						<span id=tick2></span>				
    ...
    <tr>
      <td class="TrackTitle" valign="top"><div  align="center"><h3 class="classic-title"><span><strong>Pelacakan Pengiriman daftar pelanggan</strong></span></h3>
    </tr>
	<section>
    <table border="0" align="center">
    	<tr>
			<td width="335"><form action="search-courier.php" method="post" name="form" id="form" >				
                  ...
                  <button  name="Submit" type="submit" class="btn btn-danger" onClick="MM_validateForm('Consignment','','R');return document.MM_returnValue">&nbsp;&nbsp;Cari & Edit</button></form></td>
			<td><strong></strong>&nbsp;&nbsp;&nbsp;&nbsp;</td>
			...
			<div class="table-style">
                <table class="table-list">
                    ...
                    <tr>
						...
						<th class="newtext"><font color="white">Kirim Paket</font></th>
						<th class="newtext"><font color="white">Cetak Invoice</font></th>
                        ...
                        <th class="newtext"><font color="white">Destinasi</font></th>
						<th class="newtext"><font color="white">Date / Time Pengiriman</font></th>
                        <th class="newtext"><font color="white">status pengiriman</font></th>
                    </tr>
					</tbody>
						<?php
						$records = getPageData();
...
<p></p>
	...
	<footer class="footer-basic-centered">
			...
			<p class="footer-company-name">Copyright © robialakbar Kuris & Logistik.  All rights reserved.</p>
