  ...
  <div class="one_full">
			<div class="table-style">
                <table class="table-list">
                    <tr>
                        <th class="newtext">Memperbarui Status</th>
						<th class="newtext">Kiirm Paket</th>
						<th class="newtext">Generate Barcode</th>
                        <th class="newtext"># Tracking</th>
                        <th class="newtext">Pengirim</th>
                        <th class="newtext">Penerima</th>
						<th class="newtext">Date/Time Pengiriman</th>
                        <th class="newtext">Status Pengiriman</th>
                    </tr>
					<?php
						$records = getPageData();
						if(count($records) > 0){
