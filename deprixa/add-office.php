                    ...
                    <div class="col-sm-12">
                        <div class="card-box table-responsive">
							...
							<div class="row">
									...
									<h2>Tambahkan Manajer Kantor Baru</h2>
									<br>
									</div>
								</div>
								  ...
								  <div class="modal-dialog">
									<div class="modal-content">
									  <div class="modal-header">
										...
										<h4 class="modal-title" id="myModalLabel"><i class="fa fa-user-plus"></i> Kantor Baru</h4>
									  </div>
								...
								<!--Cuerpo del modal aquí el formulario-->
								  ...
								  <div class="form-group" id="Enombre">
									<label for="off_name" class="col-sm-2 control-label">Nama Kantor </label>
									<div class="col-sm-10">
