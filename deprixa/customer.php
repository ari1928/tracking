							...
							<div class="row">
								  ...
								  <div class="modal-dialog">
									...
									<form action="settings/add-new-clients/agregar.php"  class="form-horizontal" method="post">
										  <div class="form-group " id="gnombre">
												<label for="office" class="col-sm-2 control-label">Nama Pelanggan </label>
												<div class="col-sm-10">
										  ...
										  <div class="form-group" id="gusuario">
												<label for="officer_name" class="col-sm-2 control-label">Negara</label>
												<div class="col-sm-5">
												...
												<div class="col-sm-5">
												  <select  name ="state" required  id ="state" class="fa-glass booking_form_dropdown form-control"><option value="">Pilih Provinsi</option></select>    
												  <span class="field-validation-valid text-danger" ></span>
												</div>					  
										  </div>
										  <div class="form-group" id="gusuario">
												<label for="officer_name" class="col-sm-2 control-label">Kantor</label>
												<div class="col-sm-5">
								...
								<!--Cuerpo del modal aquí el formulario-->
								  ...
								  <div class="form-group" id="Enombre">
									<label for="office" class="col-sm-2 control-label">Nama </label>
									<div class="col-sm-10">
