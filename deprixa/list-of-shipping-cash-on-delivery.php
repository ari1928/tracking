        ...
        <div class="wrapper">
			...
			<div class="row">
                    ...
                    <div class="card-box table-responsive">
						    <h4 class="header-title m-t-0 m-b-20">Daftar Pengiriman yang COD/Cash on Delivery</h4>
						<table border="0" align="center">
							<tr>				
								...
								<td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a target="_blank" href="javascript:reportepaymentcashPDF();" class="btn btn-primary">Export ke <strong>PDF</strong></a></td>
							</tr>
						</table>
