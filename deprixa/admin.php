																	...
																	<tbody>
																		<tr>
																			...
																			?>
																				...
																				<td>
																					<FONT SIZE=2><strong><?php echo $company['currency']; ?><?php echo $s . formato($row['shipping_subtotal']); ?></strong></FONT>
																				</td>
																				...
																				<td>
																					<FONT SIZE=2><?php echo $row['ship_name']; ?></FONT>
																				</td>
																				<td>
																					<FONT SIZE=2><?php echo $row['fromcity']; ?></FONT>
																				</td>
																				<td>
																					<FONT SIZE=2><?php echo $row['rev_name']; ?></FONT>
																				</td>
																				<td>
																					<FONT SIZE=2><?php echo $row['tocity']; ?></FONT>
																				</td>
																				<td>
																					<FONT SIZE=2><?php echo $row['deliverydate']; ?></FONT>
																				</td>
																				<td><span class="label <?php echo $row['status']; ?> label-large"><?php echo $row['status']; ?></span></td>
																		</tr>
																	<?php } ?>
